...
\newcommand{\cutdim}[1]{\texttt{#1}}

% ---- cut-pattern bar: \cutbar{stock}{ {len1, len2, ...} }{label}
% scale: 1 in = 0.152 cm  ->  96 in = 14.6 cm
\newcommand{\barscale}{0.152}
\newcommand{\cutbar}[3]{%
...
\begin{tabularx}{\textwidth}{@{}X r@{}}
  {\fontsize{21}{23}\selectfont\bfseries PORT-SIDE SHELVES\newline CUT LIST} &
  \begin{tabular}[b]{@{}ll@{}}
...
\textbf{If three shelves up instead of four} — removing the two topmost shelves (Bay A and Bay C at z\,81½, with their z\,78 frames) changes the buy to:
\begin{center}\small
\begin{tabularx}{\dimexpr\textwidth-2\fboxsep-2\fboxrule-8pt}{@{}l r r r X@{}}
\toprule
\textbf{Stock} & \textbf{4 shelves} & \textbf{3 shelves} & \textbf{Fewer to buy} & \textbf{What drops out} \\
\midrule
2×4 × 8 ft & 34 & 27 & \textbf{−7} & 4 × 72 rails and 10 × 29 cross members; patterns become 12 → 72, 14 → 29+29+29, 1 → 31+31 \\
2×6 × 8 ft & 10 & 10 & \textbf{0} & nothing — leave the posts full height for a later top deck, or cut them 12 in shorter; the board count is the same either way \\
⅜ in plywood, 4×8 & 5 & 4 & \textbf{−1} & 2 × 32×48 and 2 × 24×32; 10 strips from 4 sheets, 2 spare \\
\bottomrule
\end{tabularx}
\end{center}
Everything below is the four-shelf build.}}
...
\midrule
\cutdim{72}  & 16 & front/back rails, 8 frames × 2 \\
\cutdim{29}  & 52 & cross members, 49 in frames + 3 floor cleats \\
\cutdim{31}  &  2 & rails, low-step frame \\
\midrule
net & 70 & \cutdim{2722 in = 226.8 lf} \\
\bottomrule
\end{tabular}
\end{minipage}\hfill
...
\midrule
\cutdim{72}   & 2 & Bay A left end, floor (z 9½) to top \\
\cutdim{62.5} & 6 & full-height posts, x 1½ / 41 / 128 \\
\cutdim{50.5} & 2 & Bay C posts off the z 31 frame, x 77 \\
\cutdim{30.5} & 4 & Bay B lower posts, x 97 / 113 \\
\cutdim{25}   & 2 & low-step posts, x −1½ \\
\cutdim{18.5} & 2 & Bay B short posts, x 60¾ \\
\midrule
net & 18 & \cutdim{829 in = 69.1 lf} \\
\bottomrule
\end{tabular}
\end{minipage}\hfill
\begin{minipage}[t]{0.50\textwidth}
...
\midrule
\cutdim{32 × 48} &  2 & z 81½ top, Bay A and Bay C & none \\
\cutdim{32 × 48} &  8 & z 34½ ×3 · z 49½ ×3 · z 69½ ×2 & post notches, 7 patterns (A–G), drawn below \\
\cutdim{24 × 32} &  2 & z 81½ top & none \\
\cutdim{24 × 32} &  2 & z 69½, ends of Bay A / Bay C & post notches (A, B), drawn below \\
\cutdim{31 × 32} &  1 & z 22½ low step & post notches \\
\midrule
net & 15 & \multicolumn{2}{l}{\cutdim{19,424 in² = 4.22 sheets → 5}} \\
\bottomrule
\end{tabularx}

\subsection*{Panel patterns}
Every unique panel outline, read from the model. Notch callouts are \cutdim{offset + width} from the panel's left edge (as installed, looking down); front-edge notches are labelled below the panel, back-edge above. All notches are 7~in deep unless the panel says otherwise. Mark them from these dimensions, then check against the installed posts before cutting.

\noindent\input{ply_patterns.tex}
...
Port Side Shelves (Assembly)
  ...
  Bay A - Left, x -28..44
    Frame A z19          (31 in rails, 3 cross)   x1
    Frame A z31/z46/z78  (72 in rails, 5 cross)   x3  <- one component
    Frame A z66          (72 in rails, 6 cross)   x1
  Bay B - Center lower, x 44..116
    Frame B z31/z46      (72 in rails, 7 cross)   x2  <- one component
  Bay C - Right upper, x 75.5..147.5
    Frame C z66          (72 in rails, 6 cross)   x1
    Frame C z78          (72 in rails, 5 cross)   x1
  Floor cleats z19 (2x4)                        3 x 29 in
  Decks (3/8 ply)                               z 22.5 (1)  34.5 (3)  49.5 (3)  69.5 (4)  81.5 (4)
\end{verbatim}}
